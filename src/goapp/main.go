...
func main() {
	...
	muxApi.Handle("/community", loadAzAuthPage(rtApi.GetCommunities)).Methods("GET")
	muxApi.Handle("/community/{id}", loadAzAuthPage(rtApi.GetCommunityMembers)).Methods("GET")
