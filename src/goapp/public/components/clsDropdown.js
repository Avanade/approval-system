    ...
    template(id, model, data, text, subText, value=text, onClickAction=null){
        ...
        <div x-data="{
            ...
            <div class="relative mt-1" >
                <input id="input_${id}_id" name="input_${id}_name" @click="${id}_show = !${id}_show" x-model="${model}" type="text" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md border-2" role="combobox" aria-controls="options" aria-expanded="false" autocomplete="off">
