    ...
    template : `<nav class="bg-white flex items-center justify-between" aria-label="header">
            ...
            <div class="flex justify-between sm:justify-end">
                <div class="sm:col-span-3">
                    ...
                    <div class="mt.-1">
                        <input @keyup.enter="onSearchSubmitHandler" type="text" name="search" id="search"  class="block w-full focus:ring-indigo-500 focus:border-indigo-500 pl-10    sm:text-sm border-gray-300 rounded-md"   x-model="search">
                    </div>
                </div>
            </div>
        </nav>
